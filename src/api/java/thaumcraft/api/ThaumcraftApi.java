...
public class ThaumcraftApi {
    ...
    public static ArmorMaterial armorMatThaumiumFortress =
            EnumHelper.addArmorMaterial("FORTRESS", 40, new int[] {3, 7, 6, 3}, 25);
    ...
    public static ArmorMaterial armorMatVoidFortress =
            EnumHelper.addArmorMaterial("VOIDFORTRESS", 18, new int[] {4, 8, 7, 4}, 10);
    ...
    public static void addSmeltingBonus(ItemStack in, ItemStack out) {
        smeltingBonus.put(
                Arrays.asList(in.getItem(), in.getItemDamage()), new ItemStack(out.getItem(), 0, out.getItemDamage()));
    }
    ...
    public static InfusionRecipe addInfusionCraftingRecipe(
            String research, Object result, int instability, AspectList aspects, ItemStack input, ItemStack[] recipe) {
    ...
    public static InfusionEnchantmentRecipe addInfusionEnchantmentRecipe(
            String research, Enchantment enchantment, int instability, AspectList aspects, ItemStack[] recipe) {
    ...
    public static CrucibleRecipe getCrucibleRecipeFromHash(int hash) {
        for (Object r : getCraftingRecipes()) {
            if (r instanceof CrucibleRecipe) {
                if (((CrucibleRecipe) r).hash == hash) return (CrucibleRecipe) r;
            }
        }
        return null;
    }
    ...
    public static int getWarp(Object in) {
        ...
        if (in instanceof ItemStack
                && warpMap.containsKey(Arrays.asList(((ItemStack) in).getItem(), ((ItemStack) in).getItemDamage()))) {
