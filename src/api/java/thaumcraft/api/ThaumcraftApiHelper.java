...
public class ThaumcraftApiHelper {
    ...
    public static AspectList cullTags(AspectList temp) {
        ...
        for (Aspect tag : temp.getAspects()) {
            if (tag != null) temp2.add(tag, temp.getAmount(tag));
        }
    ...
    public static boolean areItemsEqual(ItemStack s1, ItemStack s2) {
        ...
        } else return s1.getItem() == s2.getItem() && s1.getItemDamage() == s2.getItemDamage();
    }
    ...
    public static boolean isResearchComplete(String username, String researchkey) {
        ...
        try {
            ...
            FMLLog.warning(
                    "[Thaumcraft API] Could not invoke thaumcraft.common.lib.research.ResearchManager method isResearchComplete");
        }
        return ot;
    }
    ...
    public static ItemStack getStackInRowAndColumn(Object instance, int row, int column) {
        ...
        try {
            ...
            FMLLog.warning(
                    "[Thaumcraft API] Could not invoke thaumcraft.common.tiles.TileMagicWorkbench method getStackInRowAndColumn");
        }
        return ot;
    }
    ...
    public static AspectList getObjectAspects(ItemStack is) {
        ...
        try {
            ...
            FMLLog.warning(
                    "[Thaumcraft API] Could not invoke thaumcraft.common.lib.crafting.ThaumcraftCraftingManager method getObjectTags");
        }
        return ot;
    }
    ...
    public static AspectList getBonusObjectTags(ItemStack is, AspectList ot) {
        ...
        try {
            ...
            FMLLog.warning(
                    "[Thaumcraft API] Could not invoke thaumcraft.common.lib.crafting.ThaumcraftCraftingManager method getBonusTags");
        }
        return ot;
    }
    ...
    public static AspectList generateTags(Item item, int meta) {
        try {
            ...
            FMLLog.warning(
                    "[Thaumcraft API] Could not invoke thaumcraft.common.lib.crafting.ThaumcraftCraftingManager method generateTags");
        }
        return null;
    }
    ...
    public static TileEntity getConnectableTile(World world, int x, int y, int z, ForgeDirection face) {
        ...
        if (te instanceof IEssentiaTransport && ((IEssentiaTransport) te).isConnectable(face.getOpposite())) return te;
        else return null;
    }
     ...
     */
    public static boolean consumeVisFromWand(
            ItemStack wand, EntityPlayer player, AspectList cost, boolean doit, boolean crafting) {
        boolean ot = false;
        try {
            if (consumeVisFromWand == null) {
                Class fake = Class.forName("thaumcraft.common.items.wands.ItemWandCasting");
                consumeVisFromWand = fake.getMethod(
                        "consumeAllVis",
                        ItemStack.class,
                        EntityPlayer.class,
                        AspectList.class,
            ...
            FMLLog.warning(
                    "[Thaumcraft API] Could not invoke thaumcraft.common.items.wands.ItemWandCasting method consumeAllVis");
        }
        return ot;
    }
     ...
     * @return was the vis successfully subtracted
     */
    public static boolean consumeVisFromWandCrafting(
            ItemStack wand, EntityPlayer player, AspectList cost, boolean doit) {
        boolean ot = false;
        try {
            if (consumeVisFromWandCrafting == null) {
                Class fake = Class.forName("thaumcraft.common.items.wands.ItemWandCasting");
                consumeVisFromWandCrafting = fake.getMethod(
                        "consumeAllVisCrafting", ItemStack.class, EntityPlayer.class, AspectList.class, boolean.class);
            }
            ...
            FMLLog.warning(
                    "[Thaumcraft API] Could not invoke thaumcraft.common.items.wands.ItemWandCasting method consumeAllVisCrafting");
        }
        return ot;
    }
    ...
    public static boolean consumeVisFromInventory(EntityPlayer player, AspectList cost) {
        ...
        try {
            if (consumeVisFromInventory == null) {
                ...
                consumeVisFromInventory =
                        fake.getMethod("consumeVisFromInventory", EntityPlayer.class, AspectList.class);
            }
            ot = (Boolean) consumeVisFromInventory.invoke(null, player, cost);
        } catch (Exception ex) {
            FMLLog.warning(
                    "[Thaumcraft API] Could not invoke thaumcraft.common.items.wands.WandManager method consumeVisFromInventory");
        }
        return ot;
    }
    ...
    public static void addWarpToPlayer(EntityPlayer player, int amount, boolean temporary) {
        ...
        try {
            if (addWarpToPlayer == null) {
                ...
                addWarpToPlayer = fake.getMethod("addWarpToPlayer", EntityPlayer.class, int.class, boolean.class);
            }
