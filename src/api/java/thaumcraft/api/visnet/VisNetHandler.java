...
public class VisNetHandler {
    ...
    public static void generateVisEffect(int dim, int x, int y, int z, int x2, int y2, int z2, int color) {
        try {
            if (generateVisEffect == null) {
                ...
                generateVisEffect = fake.getMethod(
                        "generateVisEffect",
                        int.class,
                        int.class,
                        int.class,
    ...
    public static HashMap<Integer, HashMap<WorldCoordinates, WeakReference<TileVisNode>>> sources =
            new HashMap<Integer, HashMap<WorldCoordinates, WeakReference<TileVisNode>>>();
    ...
    private static HashMap<WorldCoordinates, ArrayList<WeakReference<TileVisNode>>> nearbyNodes =
            new HashMap<WorldCoordinates, ArrayList<WeakReference<TileVisNode>>>();
    ...
    private static ArrayList<WeakReference<TileVisNode>> getAllChildren(
            TileVisNode source, ArrayList<WeakReference<TileVisNode>> list) {
