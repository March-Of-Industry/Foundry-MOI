...
public class WikiHooks {
    ...
    private static final IWikiProvider FALLBACK_PROVIDER =
            new SimpleWikiProvider("FTB Wiki", "http://wiki.feed-the-beast.com/%s");
    ...
    public static IWikiProvider getWikiFor(String mod) {
        if (!modWikis.containsKey(mod)) modWikis.put(mod, FALLBACK_PROVIDER);
