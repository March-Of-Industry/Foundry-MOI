...
public class FoundryBlocks {
    ...
    private static final String[] SLAB1_METALS = {
        "Iron", "Gold", "Copper", "Tin", "Bronze", "Electrum", "Invar", "Nickel"
    };

    private static final String[] SLAB2_METALS = {
        "Zinc", "Brass", "Silver", "Steel", "Lead", "Aluminum", "Chromium", "Platinum"
    };

    private static final String[] SLAB3_METALS = {"Manganese", "Titanium", "Cupronickel"};
    ...
    private static final String[] SLAB3_ICONS = {
        "foundry:metalblock_manganese", "foundry:metalblock_titanium", "foundry:metalblock_cupronickel"
    };
    ...
    private static void RegisterHalfSlabs(Configuration config) {
        int i;
        ...
        block_slabdouble1 = (BlockMetalSlab)
                new BlockMetalSlab(true, block_slab1, SLAB1_METALS, SLAB1_ICONS).setBlockName("metalSlabDouble1");
        block_slabdouble2 = (BlockMetalSlab)
                new BlockMetalSlab(true, block_slab2, SLAB2_METALS, SLAB2_ICONS).setBlockName("metalSlabDouble2");
        block_slabdouble3 = (BlockMetalSlab)
                new BlockMetalSlab(true, block_slab3, SLAB3_METALS, SLAB3_ICONS).setBlockName("metalSlabDouble3");
    ...
    public static void RegisterBlocks(Configuration config) {
        ...
        */
        ...
        ItemRegistry.instance.RegisterItem(
                "blockMachineICF", new ItemStack(block_machine, 1, BlockFoundryMachine.MACHINE_ICF));
        ItemRegistry.instance.RegisterItem(
                "blockMachineCaster", new ItemStack(block_machine, 1, BlockFoundryMachine.MACHINE_CASTER));
        ItemRegistry.instance.RegisterItem(
                "blockMachineAlloyMixer", new ItemStack(block_machine, 1, BlockFoundryMachine.MACHINE_ALLOYMIXER));
        ItemRegistry.instance.RegisterItem(
                "blockMachineInfuser", new ItemStack(block_machine, 1, BlockFoundryMachine.MACHINE_INFUSER));
        ItemRegistry.instance.RegisterItem(
                "blockMachineMaterialRouter",
                new ItemStack(block_machine, 1, BlockFoundryMachine.MACHINE_MATERIALROUTER));
        ...
        GameRegistry.registerCustomItemStack(
                "machineICF", new ItemStack(block_machine, 1, BlockFoundryMachine.MACHINE_ICF));
        GameRegistry.registerCustomItemStack(
                "machineCaster", new ItemStack(block_machine, 1, BlockFoundryMachine.MACHINE_CASTER));
        GameRegistry.registerCustomItemStack(
                "machineAlloyMixer", new ItemStack(block_machine, 1, BlockFoundryMachine.MACHINE_ALLOYMIXER));
        GameRegistry.registerCustomItemStack(
                "machineInfuser", new ItemStack(block_machine, 1, BlockFoundryMachine.MACHINE_INFUSER));
        GameRegistry.registerCustomItemStack(
                "machineMaterialRouter", new ItemStack(block_machine, 1, BlockFoundryMachine.MACHINE_MATERIALROUTER));
