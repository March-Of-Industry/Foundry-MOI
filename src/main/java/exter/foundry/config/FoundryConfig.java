...
public class FoundryConfig {
    ...
    public static void Load(Configuration config) {
        ...
        recipe_tools_armor =
                config.get("recipe", "recipe.tools_armor.use", true).getBoolean(true);
        ...
        recipe_steel_enable =
                config.get("recipe", "recipe.enable_infuser_steel", true).getBoolean(true);
        recipe_gear_useoredict =
                config.get("recipe", "recipe.gear_use_oredictionary", false).getBoolean(false);
    }
}
