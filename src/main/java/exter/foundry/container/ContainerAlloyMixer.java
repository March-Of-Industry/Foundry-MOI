...
public class ContainerAlloyMixer extends Container {
    ...
    public ContainerAlloyMixer(TileEntityAlloyMixer mixer, IInventory player_inventory) {
        ...
        addSlotToContainer(
                new SlotContainer(te_alloymixer, TileEntityAlloyMixer.INVENTORY_CONTAINER_INPUT_0_DRAIN, 26, 17));
        addSlotToContainer(
                new SlotContainer(te_alloymixer, TileEntityAlloyMixer.INVENTORY_CONTAINER_INPUT_0_FILL, 26, 92));
        addSlotToContainer(
                new SlotContainer(te_alloymixer, TileEntityAlloyMixer.INVENTORY_CONTAINER_INPUT_1_DRAIN, 47, 17));
        addSlotToContainer(
                new SlotContainer(te_alloymixer, TileEntityAlloyMixer.INVENTORY_CONTAINER_INPUT_1_FILL, 47, 92));
        addSlotToContainer(
                new SlotContainer(te_alloymixer, TileEntityAlloyMixer.INVENTORY_CONTAINER_INPUT_2_DRAIN, 68, 17));
        addSlotToContainer(
                new SlotContainer(te_alloymixer, TileEntityAlloyMixer.INVENTORY_CONTAINER_INPUT_2_FILL, 68, 92));
        addSlotToContainer(
                new SlotContainer(te_alloymixer, TileEntityAlloyMixer.INVENTORY_CONTAINER_INPUT_3_DRAIN, 89, 17));
        addSlotToContainer(
                new SlotContainer(te_alloymixer, TileEntityAlloyMixer.INVENTORY_CONTAINER_INPUT_3_FILL, 89, 92));
        addSlotToContainer(
                new SlotContainer(te_alloymixer, TileEntityAlloyMixer.INVENTORY_CONTAINER_OUTPUT_DRAIN, 133, 17));
        addSlotToContainer(
                new SlotContainer(te_alloymixer, TileEntityAlloyMixer.INVENTORY_CONTAINER_OUTPUT_FILL, 133, 92));
