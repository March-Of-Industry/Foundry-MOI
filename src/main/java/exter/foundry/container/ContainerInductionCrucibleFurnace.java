...
public class ContainerInductionCrucibleFurnace extends Container {
    ...
    public ContainerInductionCrucibleFurnace(
            TileEntityInductionCrucibleFurnace metalsmelter, IInventory player_inventory) {
        te_icf = metalsmelter;
        ...
        addSlotToContainer(
                new SlotContainer(te_icf, TileEntityInductionCrucibleFurnace.INVENTORY_CONTAINER_DRAIN, 135, 22));
        addSlotToContainer(
                new SlotContainer(te_icf, TileEntityInductionCrucibleFurnace.INVENTORY_CONTAINER_FILL, 135, 53));
