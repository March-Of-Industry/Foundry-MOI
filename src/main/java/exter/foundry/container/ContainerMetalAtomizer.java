...
public class ContainerMetalAtomizer extends Container {
    ...
    public ContainerMetalAtomizer(TileEntityMetalAtomizer caster, IInventory player_inventory) {
        ...
        addSlotToContainer(
                new SlotContainer(te_atomizer, TileEntityMetalAtomizer.INVENTORY_CONTAINER_WATER_DRAIN, 151, 21));
        addSlotToContainer(
                new SlotContainer(te_atomizer, TileEntityMetalAtomizer.INVENTORY_CONTAINER_WATER_FILL, 151, 51));
