...
public abstract class GuiFoundry extends GuiContainer {
     ...
     */
    private void drawTexturedModelRectFromIconPartial(
            int x, int y, IIcon icon, int width, int height, int icon_x, int icon_y, int color) {
     ...
     */
    protected void DisplayTank(
            int window_x, int window_y, int x, int y, int tank_height, int overlay_x, int overlay_y, FluidTank tank) {
            ...
            while (true) {
                ...
                if (i > 0) {
                    drawTexturedModelRectFromIconPartial(
                            window_x + x, window_y + y + tank_height - i - start, liquid_icon, 16, i, 0, 16 - i, color);
                }
                start += 16;
