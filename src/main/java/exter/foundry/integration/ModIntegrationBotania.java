...
public class ModIntegrationBotania extends ModIntegration {
    ...
    public void OnClientPostInit() {
        MaterialRegistry.instance.RegisterMaterialIcon(
                "Manasteel", new ItemStack(GameRegistry.findItem("Botania", "manaResource"), 1, 0));
        MaterialRegistry.instance.RegisterMaterialIcon(
                "Terrasteel", new ItemStack(GameRegistry.findItem("Botania", "manaResource"), 1, 4));
        MaterialRegistry.instance.RegisterMaterialIcon(
                "Elementium", new ItemStack(GameRegistry.findItem("Botania", "manaResource"), 1, 7));
    }
        ...
        if (is_loaded) {
            if (FoundryConfig.recipe_tools_armor) {
                ...
                CastingRecipeManager.instance.AddRecipe(
                        ...
                        new FluidStack(liquid_manasteel, FoundryAPI.FLUID_AMOUNT_INGOT * 8),
                        mold_chestplate,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        manasteel_pickaxe,
                        new FluidStack(liquid_manasteel, FoundryAPI.FLUID_AMOUNT_INGOT * 3),
                        mold_pickaxe,
                        extra_sticks2);
                CastingRecipeManager.instance.AddRecipe(
                        manasteel_axe,
                ...
                CastingRecipeManager.instance.AddRecipe(
                        manasteel_shovel,
                        new FluidStack(liquid_manasteel, FoundryAPI.FLUID_AMOUNT_INGOT * 1),
                        mold_shovel,
                        extra_sticks2);
                CastingRecipeManager.instance.AddRecipe(
                        manasteel_sword,
                        new FluidStack(liquid_manasteel, FoundryAPI.FLUID_AMOUNT_INGOT * 2),
                        mold_sword,
                        extra_sticks1);
                CastingRecipeManager.instance.AddRecipe(
                        manasteel_leggings,
                        new FluidStack(liquid_manasteel, FoundryAPI.FLUID_AMOUNT_INGOT * 7),
                        mold_leggings,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        manasteel_helmet,
                        new FluidStack(liquid_manasteel, FoundryAPI.FLUID_AMOUNT_INGOT * 5),
                        mold_helmet,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        manasteel_boots,
                        new FluidStack(liquid_manasteel, FoundryAPI.FLUID_AMOUNT_INGOT * 4),
                        mold_boots,
                        null);

                CastingRecipeManager.instance.AddRecipe(
                        terrasteel_chestplate,
                        new FluidStack(liquid_terrasteel, FoundryAPI.FLUID_AMOUNT_INGOT * 8),
                        mold_chestplate,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        terrasteel_sword,
                        new FluidStack(liquid_terrasteel, FoundryAPI.FLUID_AMOUNT_INGOT * 2),
                        mold_sword,
                        extra_sticks1);
                CastingRecipeManager.instance.AddRecipe(
                        terrasteel_leggings,
                        new FluidStack(liquid_terrasteel, FoundryAPI.FLUID_AMOUNT_INGOT * 7),
                        mold_leggings,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        terrasteel_helmet,
                        new FluidStack(liquid_terrasteel, FoundryAPI.FLUID_AMOUNT_INGOT * 5),
                        mold_helmet,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        terrasteel_boots,
                        new FluidStack(liquid_terrasteel, FoundryAPI.FLUID_AMOUNT_INGOT * 4),
                        mold_boots,
                        null);

                CastingRecipeManager.instance.AddRecipe(
                        elementium_chestplate,
                        new FluidStack(liquid_elementium, FoundryAPI.FLUID_AMOUNT_INGOT * 8),
                        mold_chestplate,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        elementium_pickaxe,
                        new FluidStack(liquid_elementium, FoundryAPI.FLUID_AMOUNT_INGOT * 3),
                        mold_pickaxe,
                        extra_dreamsticks2);
                CastingRecipeManager.instance.AddRecipe(
                        elementium_axe,
                ...
                CastingRecipeManager.instance.AddRecipe(
                        elementium_shovel,
                        new FluidStack(liquid_elementium, FoundryAPI.FLUID_AMOUNT_INGOT * 1),
                        mold_shovel,
                        extra_dreamsticks2);
                CastingRecipeManager.instance.AddRecipe(
                        elementium_sword,
                        new FluidStack(liquid_elementium, FoundryAPI.FLUID_AMOUNT_INGOT * 2),
                        mold_sword,
                        extra_dreamsticks1);
                CastingRecipeManager.instance.AddRecipe(
                        elementium_leggings,
                        new FluidStack(liquid_elementium, FoundryAPI.FLUID_AMOUNT_INGOT * 7),
                        mold_leggings,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        elementium_helmet,
                        new FluidStack(liquid_elementium, FoundryAPI.FLUID_AMOUNT_INGOT * 5),
                        mold_helmet,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        elementium_boots,
                        new FluidStack(liquid_elementium, FoundryAPI.FLUID_AMOUNT_INGOT * 4),
                        mold_boots,
                        null);
            ...
            MeltingRecipeManager.instance.AddRecipe(
                    manasteel_ingot, new FluidStack(liquid_manasteel, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    manasteel_block, new FluidStack(liquid_manasteel, FoundryAPI.FLUID_AMOUNT_BLOCK));
            MeltingRecipeManager.instance.AddRecipe(
                    terrasteel_ingot, new FluidStack(liquid_terrasteel, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    terrasteel_block, new FluidStack(liquid_terrasteel, FoundryAPI.FLUID_AMOUNT_BLOCK));
            MeltingRecipeManager.instance.AddRecipe(
                    elementium_ingot, new FluidStack(liquid_elementium, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    elementium_block, new FluidStack(liquid_elementium, FoundryAPI.FLUID_AMOUNT_BLOCK));

            CastingRecipeManager.instance.AddRecipe(
                    manasteel_ingot, new FluidStack(liquid_manasteel, FoundryAPI.FLUID_AMOUNT_INGOT), mold_ingot, null);
            CastingRecipeManager.instance.AddRecipe(
                    manasteel_block, new FluidStack(liquid_manasteel, FoundryAPI.FLUID_AMOUNT_BLOCK), mold_block, null);
            CastingRecipeManager.instance.AddRecipe(
                    terrasteel_ingot,
                    new FluidStack(liquid_terrasteel, FoundryAPI.FLUID_AMOUNT_INGOT),
                    mold_ingot,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    terrasteel_block,
                    new FluidStack(liquid_terrasteel, FoundryAPI.FLUID_AMOUNT_BLOCK),
                    mold_block,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    elementium_ingot,
                    new FluidStack(liquid_elementium, FoundryAPI.FLUID_AMOUNT_INGOT),
                    mold_ingot,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    elementium_block,
                    new FluidStack(liquid_elementium, FoundryAPI.FLUID_AMOUNT_BLOCK),
                    mold_block,
                    null);
