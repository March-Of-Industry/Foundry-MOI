...
public class ModIntegrationEnderIO extends ModIntegration {
    ...
    public void OnPostInit() {
        ...
        if (FoundryConfig.recipe_tools_armor) {
            ...
            ItemStack dark_steel_chestplate =
                    newItemStack(GameRegistry.findItem("EnderIO", "item.darkSteel_chestplate"));
        ...
        InfuserRecipeManager.instance.AddSubstanceRecipe(
                ...
                new ItemStack(GameRegistry.findItem("EnderIO", "itemMaterial"), 1, 0),
                6000);
        InfuserRecipeManager.instance.AddSubstanceRecipe(
                new InfuserSubstance("silicon", 36), new ItemStack(Blocks.sand, 1, 0), 240000);
        ...
        if (liquid_glowstone != null) {
            AlloyMixerRecipeManager.instance.AddRecipe(new FluidStack(liquid_energetic_alloy, 54), new FluidStack[] {
            ...
            if (destabilized_redstone != null) {
                AlloyMixerRecipeManager.instance.AddRecipe(
                        new FluidStack(liquid_energetic_alloy, 54), new FluidStack[] {
                            new FluidStack(FoundryRecipes.liquid_gold, 54),
        ...
        if (liquid_ender != null) {
            AlloyMixerRecipeManager.instance.AddRecipe(
                    ...
                    new FluidStack[] {new FluidStack(liquid_energetic_alloy, 54), new FluidStack(liquid_ender, 125)});

            AlloyMixerRecipeManager.instance.AddRecipe(new FluidStack(liquid_phased_iron, 54), new FluidStack[] {
                new FluidStack(FoundryRecipes.liquid_iron, 54), new FluidStack(liquid_ender, 125)
            });
        }

        AlloyMixerRecipeManager.instance.AddRecipe(new FluidStack(liquid_dark_steel, 27), new FluidStack[] {
            new FluidStack(FoundryRecipes.liquid_steel, 27), new FluidStack(FluidRegistry.LAVA, 250),
        });

        CastingRecipeManager.instance.AddRecipe(
                "ingotPhasedGold",
                new FluidStack(liquid_vibrant_alloy, FoundryAPI.FLUID_AMOUNT_INGOT),
                FoundryItems.Mold(ItemMold.MOLD_INGOT),
                null);
        CastingRecipeManager.instance.AddRecipe(
                "blockPhasedGold",
                new FluidStack(liquid_vibrant_alloy, FoundryAPI.FLUID_AMOUNT_BLOCK),
                FoundryItems.Mold(ItemMold.MOLD_BLOCK),
                null);
    }
}
