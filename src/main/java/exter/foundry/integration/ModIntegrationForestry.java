        ...
        if (is_loaded) {
            ...
            if (!FoundryConfig.recipe_gear_useoredict && gear_recipes) {
                ...
                MeltingRecipeManager.instance.AddRecipe(
                        copper_gear, new FluidStack(FoundryRecipes.liquid_copper, FoundryAPI.FLUID_AMOUNT_INGOT * 4));
                MeltingRecipeManager.instance.AddRecipe(
                        tin_gear, new FluidStack(FoundryRecipes.liquid_tin, FoundryAPI.FLUID_AMOUNT_INGOT * 4));
                MeltingRecipeManager.instance.AddRecipe(
                        bronze_gear, new FluidStack(FoundryRecipes.liquid_bronze, FoundryAPI.FLUID_AMOUNT_INGOT * 4));

                CastingRecipeManager.instance.AddRecipe(
                        copper_gear,
                        new FluidStack(FoundryRecipes.liquid_copper, FoundryAPI.FLUID_AMOUNT_INGOT * 4),
                        mold_gear,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        tin_gear,
                        new FluidStack(FoundryRecipes.liquid_tin, FoundryAPI.FLUID_AMOUNT_INGOT * 4),
                        mold_gear,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        bronze_gear,
