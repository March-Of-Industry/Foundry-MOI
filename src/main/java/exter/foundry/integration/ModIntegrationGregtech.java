...
public class ModIntegrationGregtech extends ModIntegration {
    ...
    public void OnPreInit(Configuration config) {
        change_recipes =
                config.get("integration", "gregtech.change_recipes", true).getBoolean(true);
        change_aluminum =
                config.get("integration", "gregtech.change_aluminum", true).getBoolean(true);
    }
    ...
    public void OnPostInit() {
        ...
        ItemStack foundrybrick_stack =
                new ItemStack(FoundryItems.item_component, 1, ItemComponent.COMPONENT_REFRACTORYBRICK);
        ...
        if (change_recipes) {
            ...
            ItemStack heating_coil2 =
                    new ItemStack(FoundryItems.item_component, 2, ItemComponent.COMPONENT_HEATINGCOIL);
            ItemStack machine_icf = new ItemStack(FoundryBlocks.block_machine, 1, BlockFoundryMachine.MACHINE_ICF);
            ItemStack machine_infuser =
            ...
            GameRegistry.addRecipe(new ShapedOreRecipe(
                    heating_coil2, "WWW", "WRW", "WWW", 'W', "wireGt02Cupronickel", 'R', redstone_stack));

            GameRegistry.addRecipe(
                    new ShapedOreRecipe(casing_stack, "IBI", "B B", "IBI", 'I', "plateSteel", 'B', foundrybrick_stack));
        ...
        AlloyMixerRecipeManager.instance.AddRecipe(new FluidStack(liquid_stainless_steel, 18), new FluidStack[] {
        ...
        AlloyMixerRecipeManager.instance.AddRecipe(
                new FluidStack(liquid_redalloy, 1),
                new FluidStack[] {new FluidStack(liquid_copper, 1), new FluidStack(liquid_redstone, 4)});

        if (destabilized_redstone != null) {
            AlloyMixerRecipeManager.instance.AddRecipe(
                    new FluidStack(liquid_redalloy, 1),
                    new FluidStack[] {new FluidStack(liquid_copper, 27), new FluidStack(destabilized_redstone, 100)});
        }
        ;
        ...
        */
        ...
        CastingRecipeManager.instance.AddRecipe(
                "ingotStainlessSteel",
                new FluidStack(liquid_stainless_steel, FoundryAPI.FLUID_AMOUNT_INGOT),
                ingot_mold,
                null);
        CastingRecipeManager.instance.AddRecipe(
                "ingotCupronickel",
                new FluidStack(liquid_cupronickel, FoundryAPI.FLUID_AMOUNT_INGOT),
                ingot_mold,
                null);
        CastingRecipeManager.instance.AddRecipe(
                "ingotKanthal", new FluidStack(liquid_kanthal, FoundryAPI.FLUID_AMOUNT_INGOT), ingot_mold, null);
        CastingRecipeManager.instance.AddRecipe(
                "ingotNichrome", new FluidStack(liquid_nichrome, FoundryAPI.FLUID_AMOUNT_INGOT), ingot_mold, null);
        CastingRecipeManager.instance.AddRecipe(
                "ingotRedAlloy", new FluidStack(liquid_redalloy, FoundryAPI.FLUID_AMOUNT_INGOT), ingot_mold, null);

        CastingRecipeManager.instance.AddRecipe(
                "blockStainlessSteel",
                new FluidStack(liquid_stainless_steel, FoundryAPI.FLUID_AMOUNT_BLOCK),
                block_mold,
                null);
        CastingRecipeManager.instance.AddRecipe(
                "blockCupronickel",
                new FluidStack(liquid_cupronickel, FoundryAPI.FLUID_AMOUNT_BLOCK),
                block_mold,
                null);
        CastingRecipeManager.instance.AddRecipe(
                "blockKanthal", new FluidStack(liquid_kanthal, FoundryAPI.FLUID_AMOUNT_BLOCK), block_mold, null);
        CastingRecipeManager.instance.AddRecipe(
                "blockNichrome", new FluidStack(liquid_nichrome, FoundryAPI.FLUID_AMOUNT_BLOCK), block_mold, null);
        CastingRecipeManager.instance.AddRecipe(
                "blockRedAlloy", new FluidStack(liquid_redalloy, FoundryAPI.FLUID_AMOUNT_BLOCK), block_mold, null);
        ...
        CastingRecipeManager.instance.AddRecipe(
                "ingotRubber", new FluidStack(liquid_rubber, FoundryAPI.FLUID_AMOUNT_INGOT), ingot_mold, null);
        CastingRecipeManager.instance.AddRecipe(
                "blockRubber", new FluidStack(liquid_rubber, FoundryAPI.FLUID_AMOUNT_BLOCK), block_mold, null);
        ...
        if (change_aluminum) {
            ...
            MeltingRecipeManager.instance.AddRecipe(
                    "oreAluminum", new FluidStack(liquid_aluminum, FoundryAPI.FLUID_AMOUNT_ORE), 3000, 80);
            MeltingRecipeManager.instance.AddRecipe(
                    "oreAluminium", new FluidStack(liquid_aluminum, FoundryAPI.FLUID_AMOUNT_ORE), 3000, 80);
            MeltingRecipeManager.instance.AddRecipe(
                    "dustAluminum", new FluidStack(liquid_aluminum, FoundryAPI.FLUID_AMOUNT_INGOT), 3000, 80);
            MeltingRecipeManager.instance.AddRecipe(
                    "dustAluminium", new FluidStack(liquid_aluminum, FoundryAPI.FLUID_AMOUNT_INGOT), 3000, 80);
            MeltingRecipeManager.instance.AddRecipe(
                    "dustSmallAluminum", new FluidStack(liquid_aluminum, FoundryAPI.FLUID_AMOUNT_INGOT / 4), 3000, 80);
            MeltingRecipeManager.instance.AddRecipe(
                    "dustSmallAluminium", new FluidStack(liquid_aluminum, FoundryAPI.FLUID_AMOUNT_INGOT / 4), 3000, 80);
            MeltingRecipeManager.instance.AddRecipe(
                    "dustTinyAluminum", new FluidStack(liquid_aluminum, FoundryAPI.FLUID_AMOUNT_INGOT / 9), 3000, 80);
            MeltingRecipeManager.instance.AddRecipe(
                    "dustTinyAluminium", new FluidStack(liquid_aluminum, FoundryAPI.FLUID_AMOUNT_INGOT / 9), 3000, 80);
        }
    }
    ...
    private void RegisterMetalRecipes(String partial_name, Fluid fluid) {
        ...
        MeltingRecipeManager.instance.AddRecipe(
                "plate" + partial_name, new FluidStack(fluid, FoundryAPI.FLUID_AMOUNT_INGOT));
        MeltingRecipeManager.instance.AddRecipe(
                "dustSmall" + partial_name, new FluidStack(fluid, FoundryAPI.FLUID_AMOUNT_INGOT / 4));
        MeltingRecipeManager.instance.AddRecipe(
                "dustTiny" + partial_name, new FluidStack(fluid, FoundryAPI.FLUID_AMOUNT_INGOT / 9));
        if (!partial_name.startsWith("Glass")) {
            ItemStack plate = FoundryMiscUtils.GetModItemFromOreDictionary("gregtech", "plate" + partial_name);
            if (plate != null) {
                CastingRecipeManager.instance.AddRecipe(
                        plate, new FluidStack(fluid, FoundryAPI.FLUID_AMOUNT_INGOT), plate_mold, null);
            }
        }
    }
}
