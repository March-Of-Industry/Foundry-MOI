...
public class ModIntegrationIC2 extends ModIntegration {
    ...
    public void OnClientPostInit() {
        ...
        MaterialRegistry.instance.RegisterTypeIcon(
                "Cable", ItemStack.copyItemStack(IC2Items.getItem("copperCableItem")));
    }
        ...
        if (is_loaded) {
            ...
            if (FoundryConfig.recipe_tools_armor) {
                ...
                CastingRecipeManager.instance.AddRecipe(
                        bronze_chestplate,
                        new FluidStack(FoundryRecipes.liquid_bronze, FoundryAPI.FLUID_AMOUNT_INGOT * 8),
                        mold_chestplate,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        bronze_pickaxe,
                        new FluidStack(FoundryRecipes.liquid_bronze, FoundryAPI.FLUID_AMOUNT_INGOT * 3),
                        mold_pickaxe,
                        extra_sticks2);
                CastingRecipeManager.instance.AddRecipe(
                        bronze_axe,
                ...
                CastingRecipeManager.instance.AddRecipe(
                        bronze_shovel,
                        new FluidStack(FoundryRecipes.liquid_bronze, FoundryAPI.FLUID_AMOUNT_INGOT * 1),
                        mold_shovel,
                        extra_sticks2);
                CastingRecipeManager.instance.AddRecipe(
                        bronze_sword,
                        new FluidStack(FoundryRecipes.liquid_bronze, FoundryAPI.FLUID_AMOUNT_INGOT * 2),
                        mold_sword,
                        extra_sticks1);
                CastingRecipeManager.instance.AddRecipe(
                        bronze_hoe,
                ...
                CastingRecipeManager.instance.AddRecipe(
                        bronze_leggings,
                        new FluidStack(FoundryRecipes.liquid_bronze, FoundryAPI.FLUID_AMOUNT_INGOT * 7),
                        mold_leggings,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        bronze_helmet,
                        new FluidStack(FoundryRecipes.liquid_bronze, FoundryAPI.FLUID_AMOUNT_INGOT * 5),
                        mold_helmet,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        bronze_boots,
                        new FluidStack(FoundryRecipes.liquid_bronze, FoundryAPI.FLUID_AMOUNT_INGOT * 4),
                        mold_boots,
                        null);
            ...
            MeltingRecipeManager.instance.AddRecipe(
                    copper_cable, new FluidStack(FoundryRecipes.liquid_copper, FoundryAPI.FLUID_AMOUNT_INGOT / 3));
            MeltingRecipeManager.instance.AddRecipe(
                    tin_cable, new FluidStack(FoundryRecipes.liquid_tin, FoundryAPI.FLUID_AMOUNT_INGOT / 3));
            MeltingRecipeManager.instance.AddRecipe(
                    gold_cable, new FluidStack(FoundryRecipes.liquid_gold, FoundryAPI.FLUID_AMOUNT_INGOT / 4));
            MeltingRecipeManager.instance.AddRecipe(
                    iron_cable, new FluidStack(FoundryRecipes.liquid_iron, FoundryAPI.FLUID_AMOUNT_INGOT / 4));

            MeltingRecipeManager.instance.AddRecipe(
                    copper_cable_insulated,
                    new FluidStack(FoundryRecipes.liquid_copper, FoundryAPI.FLUID_AMOUNT_INGOT / 3));
            MeltingRecipeManager.instance.AddRecipe(
                    tin_cable_insulated, new FluidStack(FoundryRecipes.liquid_tin, FoundryAPI.FLUID_AMOUNT_INGOT / 3));
            MeltingRecipeManager.instance.AddRecipe(
                    gold_cable_insulated,
                    new FluidStack(FoundryRecipes.liquid_gold, FoundryAPI.FLUID_AMOUNT_INGOT / 4));
            MeltingRecipeManager.instance.AddRecipe(
                    iron_cable_insulated,
                    new FluidStack(FoundryRecipes.liquid_iron, FoundryAPI.FLUID_AMOUNT_INGOT / 4));

            MeltingRecipeManager.instance.AddRecipe(
                    "itemRubber", new FluidStack(liquid_rubber, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    resin, new FluidStack(liquid_rubber, FoundryAPI.FLUID_AMOUNT_INGOT * 2), 640);

            MeltingRecipeManager.instance.AddRecipe(
                    copper_casing, new FluidStack(FoundryRecipes.liquid_copper, FoundryAPI.FLUID_AMOUNT_INGOT / 2));
            MeltingRecipeManager.instance.AddRecipe(
                    tin_casing, new FluidStack(FoundryRecipes.liquid_tin, FoundryAPI.FLUID_AMOUNT_INGOT / 2));
            MeltingRecipeManager.instance.AddRecipe(
                    bronze_casing, new FluidStack(FoundryRecipes.liquid_bronze, FoundryAPI.FLUID_AMOUNT_INGOT / 2));
            MeltingRecipeManager.instance.AddRecipe(
                    gold_casing, new FluidStack(FoundryRecipes.liquid_gold, FoundryAPI.FLUID_AMOUNT_INGOT / 2));
            MeltingRecipeManager.instance.AddRecipe(
                    iron_casing, new FluidStack(FoundryRecipes.liquid_iron, FoundryAPI.FLUID_AMOUNT_INGOT / 2));
            MeltingRecipeManager.instance.AddRecipe(
                    lead_casing, new FluidStack(FoundryRecipes.liquid_lead, FoundryAPI.FLUID_AMOUNT_INGOT / 2));
            MeltingRecipeManager.instance.AddRecipe(
                    steel_casing, new FluidStack(FoundryRecipes.liquid_steel, FoundryAPI.FLUID_AMOUNT_INGOT / 2));

            MeltingRecipeManager.instance.AddRecipe(
                    copper_plate, new FluidStack(FoundryRecipes.liquid_copper, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    tin_plate, new FluidStack(FoundryRecipes.liquid_tin, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    bronze_plate, new FluidStack(FoundryRecipes.liquid_bronze, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    gold_plate, new FluidStack(FoundryRecipes.liquid_gold, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    iron_plate, new FluidStack(FoundryRecipes.liquid_iron, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    lead_plate, new FluidStack(FoundryRecipes.liquid_lead, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    steel_plate, new FluidStack(FoundryRecipes.liquid_steel, FoundryAPI.FLUID_AMOUNT_INGOT));
            ...
            CastingRecipeManager.instance.AddRecipe(
                    tin_cable,
                    new FluidStack(FoundryRecipes.liquid_tin, FoundryAPI.FLUID_AMOUNT_INGOT / 3),
                    mold_cable,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    gold_cable,
            ...
            CastingRecipeManager.instance.AddRecipe(
                    copper_cable_insulated,
                    new FluidStack(liquid_rubber, FoundryAPI.FLUID_AMOUNT_INGOT),
                    mold_insulated_cable,
                    copper_cable);
            CastingRecipeManager.instance.AddRecipe(
                    tin_cable_insulated,
                    new FluidStack(liquid_rubber, FoundryAPI.FLUID_AMOUNT_INGOT),
            ...
            CastingRecipeManager.instance.AddRecipe(
                    gold_cable_insulated,
                    new FluidStack(liquid_rubber, FoundryAPI.FLUID_AMOUNT_INGOT * 2),
                    mold_insulated_cable,
                    gold_cable);
            CastingRecipeManager.instance.AddRecipe(
                    iron_cable_insulated,
                    new FluidStack(liquid_rubber, FoundryAPI.FLUID_AMOUNT_INGOT * 3),
                    mold_insulated_cable,
                    iron_cable);

            CastingRecipeManager.instance.AddRecipe(
                    copper_casing,
                    new FluidStack(FoundryRecipes.liquid_copper, FoundryAPI.FLUID_AMOUNT_INGOT / 2),
                    mold_casing,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    tin_casing,
                    new FluidStack(FoundryRecipes.liquid_tin, FoundryAPI.FLUID_AMOUNT_INGOT / 2),
                    mold_casing,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    bronze_casing,
            ...
            CastingRecipeManager.instance.AddRecipe(
                    gold_casing,
                    new FluidStack(FoundryRecipes.liquid_gold, FoundryAPI.FLUID_AMOUNT_INGOT / 2),
                    mold_casing,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    iron_casing,
                    new FluidStack(FoundryRecipes.liquid_iron, FoundryAPI.FLUID_AMOUNT_INGOT / 2),
                    mold_casing,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    lead_casing,
                    new FluidStack(FoundryRecipes.liquid_lead, FoundryAPI.FLUID_AMOUNT_INGOT / 2),
                    mold_casing,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    steel_casing,
                    new FluidStack(FoundryRecipes.liquid_steel, FoundryAPI.FLUID_AMOUNT_INGOT / 2),
                    mold_casing,
                    null);
            ...
            if (gti == null || !Loader.isModLoaded("gregtech")) {
                ...
                CastingRecipeManager.instance.AddRecipe(
                        tin_plate,
                        new FluidStack(FoundryRecipes.liquid_tin, FoundryAPI.FLUID_AMOUNT_INGOT),
                        mold_plate,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        bronze_plate,
                        new FluidStack(FoundryRecipes.liquid_bronze, FoundryAPI.FLUID_AMOUNT_INGOT),
                        mold_plate,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        gold_plate,
                        new FluidStack(FoundryRecipes.liquid_gold, FoundryAPI.FLUID_AMOUNT_INGOT),
                        mold_plate,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        iron_plate,
                ...
                CastingRecipeManager.instance.AddRecipe(
                        lead_plate,
                        new FluidStack(FoundryRecipes.liquid_lead, FoundryAPI.FLUID_AMOUNT_INGOT),
                        mold_plate,
                        null);
                CastingRecipeManager.instance.AddRecipe(
                        steel_plate,
