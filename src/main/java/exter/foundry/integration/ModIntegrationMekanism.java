...
public class ModIntegrationMekanism extends ModIntegration {
    ...
    public void OnPostInit() {
        ...
        if (FoundryConfig.recipe_tools_armor && Loader.isModLoaded("MekanismTools")) {
            ...
            ItemStack glowstone_chestplate =
                    newItemStack(GameRegistry.findItem("MekanismTools", "GlowstoneChestplate"));
        ...
        if (liquid_glowstone != null) {
            AlloyMixerRecipeManager.instance.AddRecipe(
                    ...
                    new FluidStack[] {new FluidStack(liquid_osmium, 54), new FluidStack(liquid_glowstone, 125)});
        }
    }
}
