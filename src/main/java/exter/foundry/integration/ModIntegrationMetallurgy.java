...
public class ModIntegrationMetallurgy extends ModIntegration {
    ...
    public void OnPostInit() {
                ...
                if (liquid_metal != null) {
                    if (!metalname.equals("Gold") && !metalname.equals("Midasium")) {
                        AlloyMixerRecipeManager.instance.AddRecipe(
                                new FluidStack(LiquidMetalRegistry.instance.GetFluid("Gold"), 1), new FluidStack[] {
                                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Midasium"), 1),
        ...
        AlloyMixerRecipeManager.instance.AddRecipe(
                new FluidStack(LiquidMetalRegistry.instance.GetFluid("DamascusSteel"), 2), new FluidStack[] {
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Iron"), 1),
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Bronze"), 1)
                });

        AlloyMixerRecipeManager.instance.AddRecipe(
                new FluidStack(LiquidMetalRegistry.instance.GetFluid("Angmallen"), 2), new FluidStack[] {
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Iron"), 1),
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Gold"), 1)
                });

        AlloyMixerRecipeManager.instance.AddRecipe(
                new FluidStack(LiquidMetalRegistry.instance.GetFluid("Haderoth"), 2), new FluidStack[] {
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Mithril"), 1),
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Rubracium"), 1)
                });

        AlloyMixerRecipeManager.instance.AddRecipe(
                new FluidStack(LiquidMetalRegistry.instance.GetFluid("Tartarite"), 2), new FluidStack[] {
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Adamantine"), 1),
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Atlarus"), 1)
                });

        AlloyMixerRecipeManager.instance.AddRecipe(
                new FluidStack(LiquidMetalRegistry.instance.GetFluid("Celenegil"), 2), new FluidStack[] {
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Orichalcum"), 1),
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Platinum"), 1)
                });

        AlloyMixerRecipeManager.instance.AddRecipe(
                new FluidStack(LiquidMetalRegistry.instance.GetFluid("Quicksilver"), 2), new FluidStack[] {
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Mithril"), 1),
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Silver"), 1)
                });

        AlloyMixerRecipeManager.instance.AddRecipe(
                new FluidStack(LiquidMetalRegistry.instance.GetFluid("Desichalkos"), 2), new FluidStack[] {
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Eximite"), 1),
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Meutoite"), 1)
                });

        AlloyMixerRecipeManager.instance.AddRecipe(
                new FluidStack(LiquidMetalRegistry.instance.GetFluid("Inolashite"), 2), new FluidStack[] {
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Alduorite"), 1),
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Ceruclase"), 1)
                });

        AlloyMixerRecipeManager.instance.AddRecipe(
                new FluidStack(LiquidMetalRegistry.instance.GetFluid("Amordrine"), 2), new FluidStack[] {
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Kalendrite"), 1),
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Platinum"), 1)
                });

        AlloyMixerRecipeManager.instance.AddRecipe(
                new FluidStack(LiquidMetalRegistry.instance.GetFluid("ShadowSteel"), 2), new FluidStack[] {
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("ShadowIron"), 1),
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Lemurite"), 1)
                });

        AlloyMixerRecipeManager.instance.AddRecipe(
                new FluidStack(LiquidMetalRegistry.instance.GetFluid("BlackSteel"), 2), new FluidStack[] {
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Infuscolium"), 1),
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("DeepIron"), 1)
                });

        AlloyMixerRecipeManager.instance.AddRecipe(
                new FluidStack(LiquidMetalRegistry.instance.GetFluid("Hepatizon"), 2), new FluidStack[] {
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Bronze"), 1),
                    new FluidStack(LiquidMetalRegistry.instance.GetFluid("Gold"), 1)
                });
    }
