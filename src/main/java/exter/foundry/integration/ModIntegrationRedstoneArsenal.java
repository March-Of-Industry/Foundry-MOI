...
public class ModIntegrationRedstoneArsenal extends ModIntegration {
    ...
    public void OnPostInit() {
        ...
        if (is_loaded) {
            ...
            AlloyMixerRecipeManager.instance.AddRecipe(new FluidStack(liquid_electrumflux, 27), new FluidStack[] {
                new FluidStack(FoundryRecipes.liquid_electrum, 27), new FluidStack(destabilized_redstone, 50)
            });

            AlloyMixerRecipeManager.instance.AddRecipe(new FluidStack(liquid_electrumflux, 5), new FluidStack[] {
                new FluidStack(FoundryRecipes.liquid_electrum, 5), new FluidStack(liquid_redstone, 4)
            });

            AlloyMixerRecipeManager.instance.AddRecipe(new FluidStack(liquid_electrumflux, 54), new FluidStack[] {
            ...
            AlloyMixerRecipeManager.instance.AddRecipe(new FluidStack(liquid_electrumflux, 10), new FluidStack[] {
            ...
            if (FoundryConfig.recipe_tools_armor) {
                ...
                if (extra_sticks1 != null && extra_sticks2 != null) {
                    ...
                    if (fluxplate != null && fluxgem2 != null) {
                        ...
                        RegisterCasting(
                                leggings,
                                new FluidStack(liquid_electrumflux, plate_amount * 7),
                                ItemMold.MOLD_LEGGINGS,
                                GameRegistry.findItemStack("RedstoneArsenal", "gemCrystalFlux", 14));
                        RegisterCasting(
                                chestplate,
                                new FluidStack(liquid_electrumflux, plate_amount * 8),
                                ItemMold.MOLD_CHESTPLATE,
                                GameRegistry.findItemStack("RedstoneArsenal", "gemCrystalFlux", 16));
                        RegisterCasting(
                                helmet,
                                new FluidStack(liquid_electrumflux, plate_amount * 5),
                                ItemMold.MOLD_HELMET,
                                GameRegistry.findItemStack("RedstoneArsenal", "gemCrystalFlux", 10));
                        RegisterCasting(
                                boots,
                                new FluidStack(liquid_electrumflux, plate_amount * 4),
                                ItemMold.MOLD_BOOTS,
                                GameRegistry.findItemStack("RedstoneArsenal", "gemCrystalFlux", 8));
                    }
                }
            }
        }
