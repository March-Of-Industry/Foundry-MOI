...
public class ModIntegrationTF extends ModIntegration {
    ...
    private static final String[] TOOL_METALS = {
        "Bronze", "Copper", "Electrum", "Invar", "Lead", "Nickel", "Platinum", "Silver", "Tin"
    };

    private static final String[] GEAR_METALS = {
        "Tin",
        "Platinum",
        "Bronze",
        "Silver",
    ...
    public void OnPreInit(Configuration config) {
        ...
        override_redstone_melting = config.get("integration", Name + ".override_redstone_melting", true)
                .getBoolean(true);
    ...
    public void OnPostInit() {
        ...
        if (is_loaded) {
            ...
            MeltingRecipeManager.instance.AddRecipe(
                    new ItemStack(Items.ender_pearl), new FluidStack(liquid_ender, 250), 1500);

            MeltingRecipeManager.instance.AddRecipe(
                    new ItemStack(Items.glowstone_dust), new FluidStack(liquid_glowstone, 250), 2500);
            MeltingRecipeManager.instance.AddRecipe(
                    new ItemStack(Blocks.glowstone), new FluidStack(liquid_glowstone, 1000), 2500);

            AtomizerRecipeManager.instance.AddRecipe(
                    new ItemStack(Items.glowstone_dust), new FluidStack(liquid_glowstone, 250));
            ...
            if (override_redstone_melting) {
                MeltingRecipeManager.instance.RemoveRecipe(
                        MeltingRecipeManager.instance.FindRecipe(new ItemStack(Items.redstone)));
                MeltingRecipeManager.instance.RemoveRecipe(
                        MeltingRecipeManager.instance.FindRecipe(new ItemStack(Blocks.redstone_block)));
                MeltingRecipeManager.instance.AddRecipe(
                        new ItemStack(Items.redstone), new FluidStack(destabilized_redstone, 100), 1000);
                MeltingRecipeManager.instance.AddRecipe(
                        new ItemStack(Blocks.redstone_block), new FluidStack(destabilized_redstone, 900), 1000);
                AtomizerRecipeManager.instance.AddRecipe(
                        new ItemStack(Items.redstone), new FluidStack(destabilized_redstone, 100));
            }

            AlloyMixerRecipeManager.instance.AddRecipe(new FluidStack(liquid_enderium, 108), new FluidStack[] {
            ...
            AlloyMixerRecipeManager.instance.AddRecipe(new FluidStack(liquid_signalum, 108), new FluidStack[] {
                new FluidStack(FoundryRecipes.liquid_copper, 81),
                new FluidStack(FoundryRecipes.liquid_silver, 27),
                new FluidStack(destabilized_redstone, 250)
            });

            AlloyMixerRecipeManager.instance.AddRecipe(new FluidStack(liquid_signalum, 4), new FluidStack[] {
            ...
            AlloyMixerRecipeManager.instance.AddRecipe(new FluidStack(liquid_lumium, 108), new FluidStack[] {
            ...
            CastingRecipeManager.instance.AddRecipe(
                    new ItemStack(Blocks.redstone_block), new FluidStack(destabilized_redstone, 900), mold_block, null);
            ...
            if (FoundryConfig.recipe_tools_armor) {
                ...
                for (String metal_name : TOOL_METALS) {
                    ItemStack pickaxe =
                            GameRegistry.findItemStack("ThermalFoundation", "tool" + metal_name + "Pickaxe", 1);
                    ItemStack axe = GameRegistry.findItemStack("ThermalFoundation", "tool" + metal_name + "Axe", 1);
                    ItemStack shovel =
                            GameRegistry.findItemStack("ThermalFoundation", "tool" + metal_name + "Shovel", 1);
                    ...
                    ItemStack helmet =
                            GameRegistry.findItemStack("ThermalFoundation", "armor" + metal_name + "Helmet", 1);
                    ItemStack chestplate =
                            GameRegistry.findItemStack("ThermalFoundation", "armor" + metal_name + "Plate", 1);
                    ItemStack leggings =
                            GameRegistry.findItemStack("ThermalFoundation", "armor" + metal_name + "Legs", 1);
                    ItemStack boots =
                            GameRegistry.findItemStack("ThermalFoundation", "armor" + metal_name + "Boots", 1);
                    ItemStack sickle =
                            GameRegistry.findItemStack("ThermalFoundation", "tool" + metal_name + "Sickle", 1);
            ...
            if (!FoundryConfig.recipe_gear_useoredict && gear_recipes) {
                ...
                for (String metal_name : GEAR_METALS) {
                    ...
                    if (gear != null) {
                        Fluid metal = LiquidMetalRegistry.instance.GetFluid(metal_name);
                        MeltingRecipeManager.instance.AddRecipe(
                                gear, new FluidStack(metal, FoundryAPI.FLUID_AMOUNT_INGOT * 4));
                        CastingRecipeManager.instance.AddRecipe(
                                gear, new FluidStack(metal, FoundryAPI.FLUID_AMOUNT_INGOT * 4), mold_gear, null);
                    }
                }
            }
        }
