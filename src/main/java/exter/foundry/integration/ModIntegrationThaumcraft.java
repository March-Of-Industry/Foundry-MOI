...
public class ModIntegrationThaumcraft extends ModIntegration {
    ...
    public void OnPreInit(Configuration config) {
        ...
        enable_shards =
                config.get("thaumcraft.liquidshards", "integration", true).getBoolean(true);
    ...
    public void OnClientPostInit() {
        ...
        MaterialRegistry.instance.RegisterTypeIcon(
                "NativeCluster", ItemStack.copyItemStack(ItemApi.getItem("itemNugget", 16)));
        MaterialRegistry.instance.RegisterTypeIcon(
                "InfusedShard", ItemStack.copyItemStack(ItemApi.getItem("itemShard", 6)));
        ...
        MaterialRegistry.instance.RegisterMaterialIcon(
                "Potentia", FoundryItems.Component(ItemComponent.COMPONENT_SHARD_ENERGY_TC));
        MaterialRegistry.instance.RegisterMaterialIcon(
                "Victus", FoundryItems.Component(ItemComponent.COMPONENT_SHARD_LIFE_TC));
        MaterialRegistry.instance.RegisterMaterialIcon(
                "Vacous", FoundryItems.Component(ItemComponent.COMPONENT_SHARD_VOID_TC));
    ...
    public void OnPostInit() {
        ...
        MeltingRecipeManager.instance.AddRecipe(
                cap_iron, new FluidStack(FoundryRecipes.liquid_iron, FoundryAPI.FLUID_AMOUNT_NUGGET * 5));
        MeltingRecipeManager.instance.AddRecipe(
                cap_copper, new FluidStack(FoundryRecipes.liquid_copper, FoundryAPI.FLUID_AMOUNT_NUGGET * 5));
        MeltingRecipeManager.instance.AddRecipe(
                cap_gold, new FluidStack(FoundryRecipes.liquid_gold, FoundryAPI.FLUID_AMOUNT_NUGGET * 5));
        MeltingRecipeManager.instance.AddRecipe(
                cap_silver, new FluidStack(FoundryRecipes.liquid_silver, FoundryAPI.FLUID_AMOUNT_NUGGET * 5));
        MeltingRecipeManager.instance.AddRecipe(
                cap_thaumium, new FluidStack(liquid_thaumium, FoundryAPI.FLUID_AMOUNT_NUGGET * 5));
        ...
        CastingRecipeManager.instance.AddRecipe(
                ...
                null);
        CastingRecipeManager.instance.AddRecipe(
                cap_thaumium, new FluidStack(liquid_thaumium, FoundryAPI.FLUID_AMOUNT_NUGGET * 5), cap_mold, null);

        if (enable_shards) {
            ThaumcraftApi.registerObjectTag(
                    FoundryItems.Component(ItemComponent.COMPONENT_SHARD_ENERGY_TC),
                    (new AspectList())
                            .add(Aspect.ENERGY, 2)
                            .add(Aspect.CRYSTAL, 1)
                            .add(Aspect.MAGIC, 1));
            ThaumcraftApi.registerObjectTag(
                    FoundryItems.Component(ItemComponent.COMPONENT_SHARD_LIFE_TC),
                    (new AspectList())
                            .add(Aspect.LIFE, 2)
                            .add(Aspect.CRYSTAL, 1)
                            .add(Aspect.MAGIC, 1));
            ThaumcraftApi.registerObjectTag(
                    FoundryItems.Component(ItemComponent.COMPONENT_SHARD_VOID_TC),
                    (new AspectList())
                            .add(Aspect.VOID, 2)
                            .add(Aspect.CRYSTAL, 1)
                            .add(Aspect.MAGIC, 1));
            ...
            MeltingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 0), new FluidStack(liquid_aer, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 1), new FluidStack(liquid_ignis, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 2), new FluidStack(liquid_aqua, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 3), new FluidStack(liquid_terra, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 4), new FluidStack(liquid_ordo, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 5), new FluidStack(liquid_perditio, FoundryAPI.FLUID_AMOUNT_INGOT));

            MeltingRecipeManager.instance.AddRecipe(
                    FoundryItems.Component(ItemComponent.COMPONENT_SHARD_ENERGY_TC),
                    new FluidStack(liquid_potentia, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    FoundryItems.Component(ItemComponent.COMPONENT_SHARD_LIFE_TC),
                    new FluidStack(liquid_victus, FoundryAPI.FLUID_AMOUNT_INGOT));
            MeltingRecipeManager.instance.AddRecipe(
                    FoundryItems.Component(ItemComponent.COMPONENT_SHARD_VOID_TC),
                    new FluidStack(liquid_vacous, FoundryAPI.FLUID_AMOUNT_INGOT));

            MeltingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 6), new FluidStack(liquid_primal, FoundryAPI.FLUID_AMOUNT_INGOT));

            CastingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 0),
                    new FluidStack(liquid_aer, FoundryAPI.FLUID_AMOUNT_INGOT),
                    shard_mold,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 1),
                    new FluidStack(liquid_ignis, FoundryAPI.FLUID_AMOUNT_INGOT),
                    shard_mold,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 2),
                    new FluidStack(liquid_aqua, FoundryAPI.FLUID_AMOUNT_INGOT),
                    shard_mold,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 3),
                    new FluidStack(liquid_terra, FoundryAPI.FLUID_AMOUNT_INGOT),
                    shard_mold,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 4),
                    new FluidStack(liquid_ordo, FoundryAPI.FLUID_AMOUNT_INGOT),
                    shard_mold,
                    null);
            CastingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 5),
                    new FluidStack(liquid_perditio, FoundryAPI.FLUID_AMOUNT_INGOT),
                    shard_mold,
                    null);
            ...
            CastingRecipeManager.instance.AddRecipe(
                    new ItemStack(shard, 1, 6),
                    new FluidStack(liquid_primal, FoundryAPI.FLUID_AMOUNT_INGOT),
                    shard_mold,
                    null);

            AlloyMixerRecipeManager.instance.AddRecipe(
                    new FluidStack(liquid_potentia, 2),
                    new FluidStack[] {new FluidStack(liquid_ignis, 1), new FluidStack(liquid_ordo, 1)});

            AlloyMixerRecipeManager.instance.AddRecipe(
                    new FluidStack(liquid_victus, 2),
                    new FluidStack[] {new FluidStack(liquid_aqua, 1), new FluidStack(liquid_terra, 1)});

            AlloyMixerRecipeManager.instance.AddRecipe(
                    new FluidStack(liquid_vacous, 2),
                    new FluidStack[] {new FluidStack(liquid_aer, 1), new FluidStack(liquid_perditio, 1)});

            AlloyMixerRecipeManager.instance.AddRecipe(new FluidStack(liquid_primal, 3), new FluidStack[] {
                new FluidStack(liquid_potentia, 1), new FluidStack(liquid_victus, 1), new FluidStack(liquid_vacous, 1)
            });
            ...
            MaterialRegistry.instance.RegisterItem(
                    FoundryItems.Component(ItemComponent.COMPONENT_SHARD_ENERGY_TC), "Potentia", "InfusedShard");
            MaterialRegistry.instance.RegisterItem(
                    FoundryItems.Component(ItemComponent.COMPONENT_SHARD_LIFE_TC), "Victus", "InfusedShard");
            MaterialRegistry.instance.RegisterItem(
                    FoundryItems.Component(ItemComponent.COMPONENT_SHARD_VOID_TC), "Vacous", "InfusedShard");
            ...
            AtomizerRecipeManager.instance.AddRecipe(
                    ItemApi.getItem("itemResource", 14) /* salis mundus */,
                    new FluidStack(liquid_primal, FoundryAPI.FLUID_AMOUNT_INGOT));
        }
    }
}
