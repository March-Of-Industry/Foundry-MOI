...
public class ModIntegrationTwilightForest extends ModIntegration {
    ...
    public void OnPostInit() {
        ...
        MeltingRecipeManager.instance.AddRecipe(
                ironwood_raw, new FluidStack(liquid_ironwood, FoundryAPI.FLUID_AMOUNT_INGOT * 2));

        MeltingRecipeManager.instance.AddRecipe(
                kightmetal_cluster, new FluidStack(liquid_knightmetal, FoundryAPI.FLUID_AMOUNT_INGOT));
        MeltingRecipeManager.instance.AddRecipe(
                kightmetal_shard, new FluidStack(liquid_knightmetal, FoundryAPI.FLUID_AMOUNT_NUGGET));
        ...
        if (FoundryConfig.recipe_tools_armor) {
            ...
            ItemStack ironwood_chestplate =
                    FindEnchanted(GameRegistry.findItem("TwilightForest", "item.ironwoodPlate"));
            ...
            ItemStack steeleaf_chestplate =
                    FindEnchanted(GameRegistry.findItem("TwilightForest", "item.steeleafPlate"));
            ...
            ItemStack knightmetal_shovel =
                    FindEnchanted(GameRegistry.findItem("TwilightForest", "item.knightlyShovel"));
            ...
            ItemStack knightmetal_chestplate =
                    FindEnchanted(GameRegistry.findItem("TwilightForest", "item.knightlyPlate"));
            ItemStack knightmetal_leggings =
                    FindEnchanted(GameRegistry.findItem("TwilightForest", "item.knightlyLegs"));
