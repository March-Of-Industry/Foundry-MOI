...
public class MTInfuserHandler {
    ...
    @ZenMethod
    public static void addRecipe(ILiquidStack output, ILiquidStack input, IInfuserSubstance substance) {
    ...
    @ZenMethod
    public static void removeRecipe(ILiquidStack input, IInfuserSubstance substance) {
        IInfuserRecipe recipe =
                InfuserRecipeManager.instance.FindRecipe(MineTweakerMC.getLiquidStack(input), substance.getSubstance());
        if (recipe == null) {
    ...
    @ZenMethod
    public static void addSubstanceRecipe(IInfuserSubstance output, IIngredient input, int energy) {
        IInfuserSubstanceRecipe recipe = null;

        try {
            recipe = new InfuserSubstanceRecipe(output.getSubstance(), MTHelper.getIngredient(input), energy);
        } catch (IllegalArgumentException e) {
    ...
    @ZenMethod
    public static void removeSubstanceRecipe(IItemStack input) {
        IInfuserSubstanceRecipe recipe =
                InfuserRecipeManager.instance.FindSubstanceRecipe(MineTweakerMC.getItemStack(input));
        if (recipe == null) {
