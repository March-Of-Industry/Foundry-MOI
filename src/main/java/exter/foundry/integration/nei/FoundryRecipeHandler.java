...
public abstract class FoundryRecipeHandler extends TemplateRecipeHandler {
    ...
    public static class ProgressBar {
        ...
        public ProgressBar(
                int posX, int posY, int texX, int texY, int maxWidth, int height, int minValue, int maxValue) {
            this.posX = posX;
            this.posY = posY;
            this.texX = texX;
            this.texY = texY;
    ...
    protected void drawTanks(List<FluidTank> tanks, int drawMultiplier, Point overlayLocation) {
        ...
        for (FluidTank tank : tanks) {
            ...
            drawFluidVertical(
                    tank.position.x,
                    tank.position.y + tank.position.height,
                    tank.position.width,
                    drawHeight,
                    tank.fluid.getFluid());
    ...
    public boolean isMouseOver(Rectangle rect, GuiRecipe gui, int recipe) {
        ...
        Rectangle absoluteLoc =
                new Rectangle(rect.x + offset.x + gui_guiLeft, rect.y + offset.y + gui_guiTop, rect.width, rect.height);
