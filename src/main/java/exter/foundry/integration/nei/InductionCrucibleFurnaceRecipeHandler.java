...
public class InductionCrucibleFurnaceRecipeHandler extends FoundryRecipeHandler {
    ...
    public static ProgressBar HEAT = new ProgressBar(
            36,
            46,
            176,
            53,
            54,
            12,
            TileEntityInductionCrucibleFurnace.HEAT_MIN,
            TileEntityInductionCrucibleFurnace.HEAT_MAX);
    ...
    public List<String> handleTooltip(GuiRecipe gui, List<String> currenttip, int recipe) {
        ...
        if (isMouseOver(HEAT.asRectangle(), gui, recipe)) {
            currenttip.add(EnumChatFormatting.GRAY + "Melting point: " + EnumChatFormatting.YELLOW
                    + meltingRecipe.meltingPoint + " K");
            float internalPower =
                    TileEntityInductionCrucibleFurnace.GetEnergyPerTickNeeded(meltingRecipe.meltingPoint * 100);
            currenttip.add(EnumChatFormatting.GRAY + "Mininum power: " + EnumChatFormatting.AQUA
                    + String.format("%.2f RF/t", internalPower / TileEntityFoundryPowered.RATIO_RF));
            currenttip.add(EnumChatFormatting.GRAY + "Mininum power: " + EnumChatFormatting.AQUA
                    + String.format("%.2f EU/t", internalPower / TileEntityFoundryPowered.RATIO_EU));
        }
