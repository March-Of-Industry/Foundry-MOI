...
public class InfuserRecipeHandler extends FoundryRecipeHandlerSubstance {
    ...
    public class CachedInfuserRecipe extends CachedFoundryRecipeSubstance {
        ...
        public CachedInfuserRecipe(IInfuserRecipe recipe) {
            ...
            allTanks.add(new FluidTank(
                    recipe.GetInputFluid(), recipe.GetInputFluid().amount, new Rectangle(80, 32, 16, 47)));
        ...
        if (substance != null && substance.amount > 0) {
            ...
            if (tex != null) {
                ...
                GuiDraw.drawTexturedModalRect(
                        rect.x, rect.y, tex.GetX(), tex.GetY(), SubstanceGuiTexture.TEXTURE_WIDTH, 47);
    ...
    public void loadTransferRects() {
        transferRects.add(
                new RecipeTransferRect(new Rectangle(107 - 5, 59 - 11, 22, 15), "foundry.infuser", new Object[0]));
    }
