...
public class InfuserSubstanceRecipeHandler extends FoundryRecipeHandlerSubstance {
    ...
    public void loadTransferRects() {
        transferRects.add(new RecipeTransferRect(
                new Rectangle(42 - 5, 59 - 11, 22, 15), "foundry.infuser.substance", new Object[0]));
    }
    ...
    public List<String> handleTooltip(GuiRecipe gui, List<String> currenttip, int recipe) {
        ...
        if (isMouseOver(PROGRESS.asRectangle(), gui, recipe)) {
            ...
            currenttip.add(
                    EnumChatFormatting.AQUA + String.format("%.1f RF/t", energy / TileEntityFoundryPowered.RATIO_RF));
            currenttip.add(
                    EnumChatFormatting.AQUA + String.format("%.1f EU/t", energy / TileEntityFoundryPowered.RATIO_EU));
        }
