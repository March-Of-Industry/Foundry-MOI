...
public class FoundryRecipes {
    ...
    public static Fluid liquid_rubber;
    ...
    public static void PreInit() {
        ...
        */
        ...
        AlloyFurnaceRecipeManager.instance.AddRecipe(
                ...
                new Object[] {new OreStack("ingotCopper", 3), new OreStack("dustCopper", 3)},
                new Object[] {new OreStack("ingotTin", 1), new OreStack("dustTin", 1)});

        AlloyFurnaceRecipeManager.instance.AddRecipe(
                new ItemStack(FoundryItems.item_ingot, 4, ItemIngot.INGOT_BRASS),
                new Object[] {new OreStack("ingotCopper", 3), new OreStack("dustCopper", 3)},
                new Object[] {new OreStack("ingotZinc", 1), new OreStack("dustZinc", 1)});

        AlloyFurnaceRecipeManager.instance.AddRecipe(
                new ItemStack(FoundryItems.item_ingot, 3, ItemIngot.INGOT_INVAR),
                new Object[] {new OreStack("ingotIron", 2), new OreStack("dustIron", 2)},
                new Object[] {new OreStack("ingotNickel", 1), new OreStack("dustNickel", 1)});

        AlloyFurnaceRecipeManager.instance.AddRecipe(
                new ItemStack(FoundryItems.item_ingot, 2, ItemIngot.INGOT_ELECTRUM),
                new Object[] {new OreStack("ingotGold", 1), new OreStack("dustGold", 1)},
                new Object[] {new OreStack("ingotSilver", 1), new OreStack("dustSilver", 1)});

        AlloyFurnaceRecipeManager.instance.AddRecipe(
                new ItemStack(FoundryItems.item_ingot, 2, ItemIngot.INGOT_CUPRONICKEL),
                new Object[] {new OreStack("ingotCopper", 1), new OreStack("dustCopper", 1)},
                new Object[] {new OreStack("ingotNickel", 1), new OreStack("dustNickel", 1)});
        ...
        */
        if (FoundryConfig.recipe_gear_useoredict) {
            for (String name : LiquidMetalRegistry.instance.GetFluidNames()) {
                ...
                MeltingRecipeManager.instance.AddRecipe(
                        "gear" + name, new FluidStack(fluid, FoundryAPI.FLUID_AMOUNT_INGOT * 4));
                CastingRecipeManager.instance.AddRecipe(
                        "gear" + name, new FluidStack(fluid, FoundryAPI.FLUID_AMOUNT_INGOT * 4), mold_gear, null);
            }
        }

        if (FoundryConfig.recipe_glass) {
            final String[] oredict_names = {
                "dyeBlack",
                "dyeRed",
                "dyeGreen",
                "dyeBrown",
            ...
            MeltingRecipeManager.instance.AddRecipe(
                    new ItemStack(Blocks.sand), new FluidStack(liquid_glass, 1000), temp, 250);
            MeltingRecipeManager.instance.AddRecipe(
                    new ItemStack(Blocks.glass), new FluidStack(liquid_glass, 1000), temp, 250);
            MeltingRecipeManager.instance.AddRecipe(
                    new ItemStack(Blocks.glass_pane), new FluidStack(liquid_glass, 375), temp, 250);
            CastingRecipeManager.instance.AddRecipe(
                    new ItemStack(Blocks.glass), new FluidStack(liquid_glass, 1000), mold_block, null, 400);
            ...
            for (i = 0; i < ItemDye.field_150921_b /*icon_names*/.length; i++) {
                ...
                Fluid liquid_glass_colored = LiquidMetalRegistry.instance.RegisterLiquidMetal(
                        "Glass." + name, temp, 12, "liquidGlass", fluid_color);

                int meta = ~i & 15;
                MeltingRecipeManager.instance.AddRecipe(
                        new ItemStack(Blocks.stained_glass, 1, meta),
                        new FluidStack(liquid_glass_colored, 1000),
                        temp,
                        250);
                MeltingRecipeManager.instance.AddRecipe(
                        new ItemStack(Blocks.stained_glass_pane, 1, meta),
                        new FluidStack(liquid_glass_colored, 375),
                        temp,
                        250);
                CastingRecipeManager.instance.AddRecipe(
                        new ItemStack(Blocks.stained_glass, 1, meta),
                ...
                InfuserRecipeManager.instance.AddSubstanceRecipe(
                        new InfuserSubstance("dye." + name, 200), oredict_names[i], 25000);
                InfuserRecipeManager.instance.AddRecipe(
                        new FluidStack(liquid_glass_colored, 40),
                        new FluidStack(liquid_glass, 40),
                        new InfuserSubstance("dye." + name, 1));
            }
        }
        ...
        MeltingRecipeManager.instance.AddRecipe(
                bullet, new FluidStack(liquid_lead, FoundryAPI.FLUID_AMOUNT_NUGGET * 3));
        MeltingRecipeManager.instance.AddRecipe(
                bullet_hollow, new FluidStack(liquid_lead, FoundryAPI.FLUID_AMOUNT_NUGGET * 3));
        MeltingRecipeManager.instance.AddRecipe(
                bullet_jacketed, new FluidStack(liquid_copper, FoundryAPI.FLUID_AMOUNT_NUGGET));
        MeltingRecipeManager.instance.AddRecipe(
                bullet_casing, new FluidStack(liquid_brass, FoundryAPI.FLUID_AMOUNT_NUGGET));
        MeltingRecipeManager.instance.AddRecipe(pellet, new FluidStack(liquid_lead, FoundryAPI.FLUID_AMOUNT_NUGGET));
        MeltingRecipeManager.instance.AddRecipe(
                shell_casing, new FluidStack(liquid_brass, FoundryAPI.FLUID_AMOUNT_NUGGET * 2));
        MeltingRecipeManager.instance.AddRecipe(
                bullet_steel, new FluidStack(liquid_steel, FoundryAPI.FLUID_AMOUNT_NUGGET * 3));
        MeltingRecipeManager.instance.AddRecipe(
                pellet_steel, new FluidStack(liquid_steel, FoundryAPI.FLUID_AMOUNT_NUGGET));

        MeltingRecipeManager.instance.AddRecipe(
                gun_barrel, new FluidStack(liquid_steel, FoundryAPI.FLUID_AMOUNT_INGOT));
        MeltingRecipeManager.instance.AddRecipe(
                revolver_drum, new FluidStack(liquid_steel, FoundryAPI.FLUID_AMOUNT_INGOT * 3 / 4));
        MeltingRecipeManager.instance.AddRecipe(
                revolver_frame, new FluidStack(liquid_steel, FoundryAPI.FLUID_AMOUNT_INGOT * 3 / 2));
        MeltingRecipeManager.instance.AddRecipe(
                shotgun_pump, new FluidStack(liquid_steel, FoundryAPI.FLUID_AMOUNT_INGOT / 2));
        MeltingRecipeManager.instance.AddRecipe(
                shotgun_frame, new FluidStack(liquid_steel, FoundryAPI.FLUID_AMOUNT_INGOT * 3 / 2));

        CastingRecipeManager.instance.AddRecipe(
                bullet, new FluidStack(liquid_lead, FoundryAPI.FLUID_AMOUNT_NUGGET * 3), mold_bullet, null);
        CastingRecipeManager.instance.AddRecipe(
                bullet_hollow,
                ...
                null);
        CastingRecipeManager.instance.AddRecipe(
                bullet_jacketed, new FluidStack(liquid_copper, FoundryAPI.FLUID_AMOUNT_NUGGET), mold_bullet, bullet);
        CastingRecipeManager.instance.AddRecipe(
                bullet_casing, new FluidStack(liquid_brass, FoundryAPI.FLUID_AMOUNT_NUGGET), mold_bullet_casing, null);
        CastingRecipeManager.instance.AddRecipe(
                pellet, new FluidStack(liquid_lead, FoundryAPI.FLUID_AMOUNT_NUGGET), mold_pellet, null);
        CastingRecipeManager.instance.AddRecipe(
                shell_casing,
                ...
                null);
        CastingRecipeManager.instance.AddRecipe(
                bullet_steel, new FluidStack(liquid_steel, FoundryAPI.FLUID_AMOUNT_NUGGET * 3), mold_bullet, null);
        CastingRecipeManager.instance.AddRecipe(
                pellet_steel, new FluidStack(liquid_steel, FoundryAPI.FLUID_AMOUNT_NUGGET), mold_pellet, null);

        CastingRecipeManager.instance.AddRecipe(
                gun_barrel, new FluidStack(liquid_steel, FoundryAPI.FLUID_AMOUNT_INGOT), mold_gun_barrel, null);
        CastingRecipeManager.instance.AddRecipe(
                revolver_drum,
        ...
        CastingRecipeManager.instance.AddRecipe(
                ...
                null);
        CastingRecipeManager.instance.AddRecipe(
                shotgun_pump, new FluidStack(liquid_steel, FoundryAPI.FLUID_AMOUNT_INGOT / 2), mold_shotgun_pump, null);
        CastingRecipeManager.instance.AddRecipe(
                shotgun_frame,
                new FluidStack(liquid_steel, FoundryAPI.FLUID_AMOUNT_INGOT * 3 / 2),
                mold_shotgun_frame,
    ...
    public static void Init() {
        ...
        GameRegistry.addRecipe(foundryclay8_stack, "CCC", "CSC", "CCC", 'C', clay_stack, 'S', sand_stack);

        GameRegistry.addShapelessRecipe(foundryclay8_stack, clayblock_stack, clayblock_stack, sand_stack);

        FurnaceRecipes.smelting()
                .func_151394_a /*addSmelting*/(
                        FoundryItems.Component(ItemComponent.COMPONENT_REFRACTORYCLAY), refbrick_stack, 0.0f);

        GameRegistry.addRecipe(blankmold_stack, "CC", 'C', foundryclay_stack);
        ...
        GameRegistry.addRecipe(casing_stack, "IBI", "B B", "IBI", 'I', iron_stack, 'B', refbrick_stack);
        ...
        GameRegistry.addRecipe(
                ...
                "GG",
                'G',
                FoundryItems.Component(ItemComponent.COMPONENT_GUNPOWDER_SMALL));
        ...
        GameRegistry.addRecipe(
                ...
                "BB",
                'B',
                FoundryItems.Component(ItemComponent.COMPONENT_BLAZEPOWDER_SMALL));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(
                ...
                "C",
                'B',
                FoundryItems.Component(ItemComponent.COMPONENT_AMMO_BULLET_JACKETED),
                'G',
                "dustSmallGunpowder",
                'C',
                FoundryItems.Component(ItemComponent.COMPONENT_AMMO_CASING)));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(
                FoundryItems.item_round_fire, "B", "A", 'B', "dustSmallBlaze", 'A', FoundryItems.item_round_hollow));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(
                ...
                "C",
                'B',
                FoundryItems.Component(ItemComponent.COMPONENT_AMMO_BULLET_STEEL),
                'G',
                "dustSmallGunpowder",
                'C',
                FoundryItems.Component(ItemComponent.COMPONENT_AMMO_CASING)));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(
                ...
                "PCP",
                'P',
                FoundryItems.Component(ItemComponent.COMPONENT_AMMO_PELLET_STEEL),
                'A',
                paper_stack,
                'G',
                "dustSmallGunpowder",
        ...
        GameRegistry.addSmelting(
                FoundryItems.Component(ItemComponent.COMPONENT_DUST_ZINC), FoundryItems.Ingot(ItemIngot.INGOT_ZINC), 0);
        ...
        if (FoundryConfig.recipe_tools_armor) {
            FoundryMiscUtils.RegisterMoldRecipe(
                    ItemMold.MOLD_CHESTPLATE_SOFT, new ItemStack(Items.iron_chestplate, 1, -1));
            FoundryMiscUtils.RegisterMoldRecipe(
                    ItemMold.MOLD_CHESTPLATE_SOFT, new ItemStack(Items.golden_chestplate, 1, -1));
            FoundryMiscUtils.RegisterMoldRecipe(
                    ItemMold.MOLD_CHESTPLATE_SOFT, new ItemStack(Items.diamond_chestplate, 1, -1));
            FoundryMiscUtils.RegisterMoldRecipe(ItemMold.MOLD_LEGGINGS_SOFT, new ItemStack(Items.iron_leggings, 1, -1));
            FoundryMiscUtils.RegisterMoldRecipe(
                    ItemMold.MOLD_LEGGINGS_SOFT, new ItemStack(Items.golden_leggings, 1, -1));
            FoundryMiscUtils.RegisterMoldRecipe(
                    ItemMold.MOLD_LEGGINGS_SOFT, new ItemStack(Items.diamond_leggings, 1, -1));
        ...
        FoundryMiscUtils.RegisterMoldRecipe(
                ItemMold.MOLD_BULLET_SOFT, FoundryItems.Component(ItemComponent.COMPONENT_AMMO_BULLET));
        FoundryMiscUtils.RegisterMoldRecipe(
                ItemMold.MOLD_BULLET_HOLLOW_SOFT, FoundryItems.Component(ItemComponent.COMPONENT_AMMO_BULLET_HOLLOW));
        FoundryMiscUtils.RegisterMoldRecipe(
                ItemMold.MOLD_BULLET_CASING_SOFT, FoundryItems.Component(ItemComponent.COMPONENT_AMMO_CASING));
        FoundryMiscUtils.RegisterMoldRecipe(
                ItemMold.MOLD_GUN_BARREL_SOFT, FoundryItems.Component(ItemComponent.COMPONENT_GUN_BARREL));
        FoundryMiscUtils.RegisterMoldRecipe(
                ItemMold.MOLD_REVOLVER_DRUM_SOFT, FoundryItems.Component(ItemComponent.COMPONENT_REVOLVER_DRUM));
        FoundryMiscUtils.RegisterMoldRecipe(
                ItemMold.MOLD_REVOLVER_FRAME_SOFT, FoundryItems.Component(ItemComponent.COMPONENT_REVOLVER_FRAME));
        FoundryMiscUtils.RegisterMoldRecipe(
                ItemMold.MOLD_PELLET_SOFT, FoundryItems.Component(ItemComponent.COMPONENT_AMMO_PELLET));
        FoundryMiscUtils.RegisterMoldRecipe(
                ItemMold.MOLD_SHELL_CASING_SOFT, FoundryItems.Component(ItemComponent.COMPONENT_AMMO_CASING_SHELL));
        FoundryMiscUtils.RegisterMoldRecipe(
                ItemMold.MOLD_SHOTGUN_PUMP_SOFT, FoundryItems.Component(ItemComponent.COMPONENT_SHOTGUN_PUMP));
        FoundryMiscUtils.RegisterMoldRecipe(
                ItemMold.MOLD_SHOTGUN_FRAME_SOFT, FoundryItems.Component(ItemComponent.COMPONENT_SHOTGUN_FRAME));
        ...
        FoundryMiscUtils.RegisterMoldSmelting(
                ItemMold.MOLD_INSULATED_CABLE_IC2_SOFT, ItemMold.MOLD_INSULATED_CABLE_IC2);
    ...
    public static void PostInit() {
        if (OreDictionary.getOres("gearStone").size() == 0) {
            ...
            GameRegistry.addRecipe((ItemStack) gear_stack, " C ", "CSC", " C ", 'C', cobble_stack, 'S', stick_stack);
        }
        /*
