...
public class RendererItemContainer implements IItemRenderer {
    ...
    private void renderIconPartial(
            int x, int y, IIcon icon, int width, int height, int icon_x, int icon_y, int color, int alpha) {
            ...
            if (fluid_icon != null) {
                ...
                if (h > 0) {
                    ...
                    renderIconPartial(
                            ...
                            4,
                            16 - 3 - h,
                            fluid_stack.getFluid().getColor(fluid_stack),
                            alpha);
