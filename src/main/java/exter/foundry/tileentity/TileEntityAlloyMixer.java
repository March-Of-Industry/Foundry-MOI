...
public class TileEntityAlloyMixer extends TileEntityFoundryPowered implements ISidedInventory, IFluidHandler {
    ...
    private static final int NETDATAID_TANK_INPUT_0_FLUID = 0;
    private static final int NETDATAID_TANK_INPUT_0_AMOUNT = 1;
    private static final int NETDATAID_TANK_INPUT_1_FLUID = 2;
    private static final int NETDATAID_TANK_INPUT_1_AMOUNT = 3;
    private static final int NETDATAID_TANK_INPUT_2_FLUID = 4;
    private static final int NETDATAID_TANK_INPUT_2_AMOUNT = 5;
    private static final int NETDATAID_TANK_INPUT_3_FLUID = 6;
    private static final int NETDATAID_TANK_INPUT_3_AMOUNT = 7;
    private static final int NETDATAID_TANK_OUTPUT_FLUID = 8;
    private static final int NETDATAID_TANK_OUTPUT_AMOUNT = 9;
