...
public class TileEntityMetalAtomizer extends TileEntityFoundryPowered implements ISidedInventory, IFluidHandler {
    ...
    private static final int NETDATAID_WATER_TANK_FLUID = 3;
    private static final int NETDATAID_WATER_TANK_AMOUNT = 4;
    ...
    private boolean CanAtomizeCurrentRecipe() {
        if (tanks[TANK_WATER].getFluid() == null
                || !tanks[TANK_WATER].getFluid().containsFluid(water_required)) {
            return false;
        }
